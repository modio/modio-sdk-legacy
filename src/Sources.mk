...
MODIO_SOURCES=ModIOSDK.cpp Globals.cpp Filter.cpp handlers/ModHandler.cpp handlers/ModfileHandler.cpp ModMethods.cpp AuthenticationMethods.cpp Utility.cpp $(MODIO_WRAPPERS) $(MODIO_DEPENDENCIES) $(MODIO_DATA_CONTAINERS)
