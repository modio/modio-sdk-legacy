...
MODIO_INSTANCE_METHODS=instance_methods/FilterInstanceMethods.cpp instance_methods/AuthenticationInstanceMethods.cpp instance_methods/ImageInstanceMethods.cpp instance_methods/ModInstanceMethods.cpp
MODIO_SOURCES=ModIOSDK.cpp ModIOInstance.cpp Globals.cpp Filter.cpp handlers/ModHandler.cpp handlers/ModfileHandler.cpp Utility.cpp $(MODIO_WRAPPERS) $(MODIO_DEPENDENCIES) $(MODIO_DATA_CONTAINERS) $(MODIO_METHODS) $(MODIO_INSTANCE_METHODS)
