...
void Instance::getAllModComments(u32 mod_id, modio::FilterCreator &filter, const std::function<void(const modio::Response &response, const std::vector<modio::Comment> &comments)> &callback)
{
    ...
    get_all_mod_comments_calls[current_call_id] = (GetAllModCommentsCall *)get_all_mod_comments_call;

    modioGetAllModComments((void *)new u32(current_call_id), mod_id, *filter.getFilter(), &onGetAllModComments);
...
void Instance::getModComment(u32 mod_id, u32 comment_id, const std::function<void(const modio::Response &response, const modio::Comment &comment)> &callback)
{
    ...
    get_mod_comment_calls[current_call_id] = (GetModCommentCall *)get_mod_comment_call;

    modioGetModComment((void *)new u32(current_call_id), mod_id, comment_id, &onGetModComment);
...
void Instance::deleteModComment(u32 mod_id, u32 comment_id, const std::function<void(const modio::Response &response)> &callback)
{
    ...
    delete_mod_comment_calls[current_call_id] = (GenericCall *)delete_mod_comment_call;

    modioDeleteModComment((void *)new u32(current_call_id), mod_id, comment_id, &onDeleteModComment);
