...
void Instance::addModLogo(u32 mod_id, std::string logo_path, const std::function<void(const modio::Response &response)> &callback)
{
  ...
  add_mod_logo_calls[current_call_id] = (GenericCall *)add_mod_logo_call;

  modioAddModLogo((void *)new u32(current_call_id), mod_id, logo_path.c_str(), &onAddModLogo);
...
void Instance::addModImages(u32 mod_id, std::vector<std::string> image_paths, const std::function<void(const modio::Response &response)> &callback)
{
  ...
  add_mod_images_calls[current_call_id] = (GenericCall *)add_mod_images_call;

  modioAddModImages((void *)new u32(current_call_id), mod_id, image_paths_array, (u32)image_paths.size(), &onAddModImages);
...
void Instance::addModYoutubeLinks(u32 mod_id, std::vector<std::string> youtube_links, const std::function<void(const modio::Response &response)> &callback)
{
  ...
  add_mod_youtube_links_calls[current_call_id] = (GenericCall *)add_mod_youtube_links_call;

  modioAddModYoutubeLinks((void *)new u32(current_call_id), mod_id, youtube_links_array, (u32)youtube_links.size(), &onAddModYoutubeLinks);
...
void Instance::addModSketchfabLinks(u32 mod_id, std::vector<std::string> sketchfab_links, const std::function<void(const modio::Response &response)> &callback)
{
  ...
  add_mod_sketchfab_links_calls[current_call_id] = (GenericCall *)add_mod_sketchfab_links_call;

  modioAddModSketchfabLinks((void *)new u32(current_call_id), mod_id, sketchfab_links_array, (u32)sketchfab_links.size(), &onAddModSketchfabLinks);
...
void Instance::deleteModImages(u32 mod_id, std::vector<std::string> image_paths, const std::function<void(const modio::Response &response)> &callback)
{
  ...
  delete_mod_images_calls[current_call_id] = (GenericCall *)delete_mod_images_call;

  modioDeleteModImages((void *)new u32(current_call_id), mod_id, image_paths_array, (u32)image_paths.size(), &onDeleteModImages);
...
void Instance::deleteModYoutubeLinks(u32 mod_id, std::vector<std::string> youtube_links, const std::function<void(const modio::Response &response)> &callback)
{
  ...
  delete_mod_youtube_links_calls[current_call_id] = (GenericCall *)delete_mod_youtube_links_call;

  modioDeleteModYoutubeLinks((void *)new u32(current_call_id), mod_id, youtube_links_array, (u32)youtube_links.size(), &onDeleteModYoutubeLinks);
...
void Instance::deleteModSketchfabLinks(u32 mod_id, std::vector<std::string> sketchfab_links, const std::function<void(const modio::Response &response)> &callback)
{
  ...
  delete_mod_sketchfab_links_calls[current_call_id] = (GenericCall *)delete_mod_sketchfab_links_call;

  modioDeleteModSketchfabLinks((void *)new u32(current_call_id), mod_id, sketchfab_links_array, (u32)sketchfab_links.size(), &onDeleteModSketchfabLinks);
