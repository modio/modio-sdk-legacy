...
void Instance::getAuthenticatedUser(const std::function<void(const modio::Response &response, const modio::User &user)> &callback)
{
  ...
  get_authenticated_user_calls[current_call_id] = (GetAuthenticatedUserCall *)get_authenticated_user_call;

  modioGetAuthenticatedUser((void *)new u32(current_call_id), &onGetAuthenticatedUser);
...
void Instance::getUserSubscriptions(modio::FilterCreator &filter, const std::function<void(const modio::Response &response, const std::vector<modio::Mod> &mods)> &callback)
{
  ...
  get_user_subscriptions_calls[current_call_id] = (GetUserSubscriptionsCall *)get_user_subscriptions_call;

  modioGetUserSubscriptions((void *)new u32(current_call_id), *filter.getFilter(), &onGetUserSubscriptions);
...
void Instance::getUserEvents(modio::FilterCreator &filter, const std::function<void(const modio::Response &, const std::vector<modio::UserEvent> &events)> &callback)
{
  ...
  get_user_events_calls[current_call_id] = (GetUserEventsCall *)get_user_events_call;

  modioGetUserEvents((void *)new u32(current_call_id), *filter.getFilter(), &onGetUserEvents);
...
void Instance::getUserGames(modio::FilterCreator &filter, const std::function<void(const modio::Response &response, const std::vector<modio::Game> &games)> &callback)
{
  ...
  get_user_games_calls[current_call_id] = (GetUserGamesCall *)get_user_games_call;

  modioGetUserGames((void *)new u32(current_call_id), *filter.getFilter(), &onGetUserGames);
...
void Instance::getUserMods(modio::FilterCreator &filter, const std::function<void(const modio::Response &response, const std::vector<modio::Mod> &mods)> &callback)
{
  ...
  get_user_mods_calls[current_call_id] = (GetUserModsCall *)get_user_mods_call;

  modioGetUserMods((void *)new u32(current_call_id), *filter.getFilter(), &onGetUserMods);
...
void Instance::getUserModfiles(modio::FilterCreator &filter, const std::function<void(const modio::Response &response, const std::vector<modio::Modfile> &modfiles)> &callback)
{
  ...
  get_user_modfiles_calls[current_call_id] = (GetUserModfilesCall *)get_user_modfiles_call;

  modioGetUserModfiles((void *)new u32(current_call_id), *filter.getFilter(), &onGetUserModfiles);
...
void Instance::getUserRatings(modio::FilterCreator &filter, const std::function<void(const modio::Response &response, const std::vector<modio::Rating> &ratings)> &callback)
{
  ...
  get_user_ratings_calls[current_call_id] = (GetUserRatingsCall *)get_user_ratings_call;

  modioGetUserRatings((void *)new u32(current_call_id), *filter.getFilter(), &onGetUserRatings);
