...
extern "C"
{
  void modioInitAddModfileHandler(ModioModfileCreator* modfile_creator)
  {
  ...
  void modioSetAddModfileVersion(ModioModfileCreator* modfile_creator, char* version)
  {
  ...
  void modioSetAddModfileChangelog(ModioModfileCreator* modfile_creator, char* changelog)
  {
  ...
  void modioSetAddModfilePath(ModioModfileCreator* modfile_creator, char* path)
  {
  ...
  void modioSetAddModfileActive(ModioModfileCreator* modfile_creator, bool active)
  {
  ...
  void modioSetAddModfileFilehash(ModioModfileCreator* modfile_creator, char* filehash)
  {
  ...
  void modioDeleteAddModfileHandler(ModioModfileCreator* modfile_creator)
  {
    if(modfile_creator->path)
      delete modfile_creator->path;
