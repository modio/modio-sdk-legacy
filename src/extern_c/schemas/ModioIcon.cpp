...
extern "C"
{
  void modioInitIcon(ModioIcon* icon, json icon_json)
  {
    ...
    if(modio::hasKey(icon_json, "filename"))
    {
      ...
      strcpy_s(icon->filename, filename_str.size() + 1, filename_str.c_str());
    }
    ...
    if(modio::hasKey(icon_json, "original"))
    {
      ...
      strcpy_s(icon->original, original_str.size() + 1, original_str.c_str());
    }
    ...
    if(modio::hasKey(icon_json, "thumb_64x64"))
    {
      ...
      strcpy_s(icon->thumb_64x64, thumb_64x64_str.size() + 1, thumb_64x64_str.c_str());
    }
    ...
    if(modio::hasKey(icon_json, "thumb_128x128"))
    {
      ...
      strcpy_s(icon->thumb_128x128, thumb_128x128_str.size() + 1, thumb_128x128_str.c_str());
    }
    ...
    if(modio::hasKey(icon_json, "thumb_256x256"))
    {
      ...
      strcpy_s(icon->thumb_256x256, thumb_256x256_str.size() + 1, thumb_256x256_str.c_str());
    }
  }
