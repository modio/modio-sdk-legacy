...
extern "C"
{
  void modioInitLogo(ModioLogo* logo, json logo_json)
  {
    ...
    if(modio::hasKey(logo_json, "filename"))
    {
      ...
      strcpy_s(logo->filename, filename_str.size() + 1, filename_str.c_str());
    }
    ...
    if(modio::hasKey(logo_json, "original"))
    {
      ...
      strcpy_s(logo->original, original_str.size() + 1, original_str.c_str());
    }
    ...
    if(modio::hasKey(logo_json, "thumb_320x180"))
    {
      ...
      strcpy_s(logo->thumb_320x180, thumb_320x180_str.size() + 1, thumb_320x180_str.c_str());
    }
    ...
    if(modio::hasKey(logo_json, "thumb_640x360"))
    {
      ...
      strcpy_s(logo->thumb_640x360, thumb_640x360_str.size() + 1, thumb_640x360_str.c_str());
    }
    ...
    if(modio::hasKey(logo_json, "thumb_1280x720"))
    {
      ...
      strcpy_s(logo->thumb_1280x720, thumb_1280x720_str.size() + 1, thumb_1280x720_str.c_str());
    }
  }
