...
extern "C"
{
  ...
  {
    std::string url_without_api_key = modio::MODIO_URL + modio::MODIO_VERSION_PATH + "games/" + modio::toString(modio::GAME_ID) + "/mods/" + modio::toString(mod_id) + "/files?" + (filter_string ? filter_string : "");
    ...
    get_all_modfiles_callbacks[call_number]->url = url_without_api_key;
